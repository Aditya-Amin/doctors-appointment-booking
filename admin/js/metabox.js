    ...
    $('#add-social').on('click', function () {
        $('#social-repeater').append(`
                    <div class="social-row">
                        <select name="doctor_socials[${socialIndex}][platform]">
                            <option value="fa-facebook-f">Facebook</option>
                            <option value="fa-linkedin-in">LinkedIn</option>
                            <option value="fa-instagram">Instagram</option>
                            <option value="fa-youtube">YouTube</option>
                        </select>
                        <input type="url" name="doctor_socials[${socialIndex}][url]" placeholder="https://..." />
    ...
    $('#add-availability').on('click', function () {
        $('#availability-container').append(`
                    <div class="availability-row">
                        <select name="doctor_availability[${availabilityIndex}][day]">
                        ...
                        <input type="time" name="doctor_availability[${availabilityIndex}][from]" />
                        <input type="time" name="doctor_availability[${availabilityIndex}][to]" />
                        <button type="button" class="remove-row">Remove</button>
                    </div>
                `);
        availabilityIndex++;
